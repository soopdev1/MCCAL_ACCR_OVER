        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="page-title"><%=Constant.titlepro%> - Carica documenti</h3>
                        </div>
                    ...
                    %>
                    <div class="col-md-12">
                        <form action="Upload?action=simpleConvenzioniSA" method="POST" enctype="multipart/form-data" >
                            <input type="hidden" name="tipodoc" value="<%=coddoc%>"/>
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-blue"><i class="fa fa-upload font-blue"></i>Carica documento:</div>
                                    <div class="tools"> 
