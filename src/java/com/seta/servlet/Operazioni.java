...
import static com.seta.action.Constant.USER_AGENT;
import static com.seta.action.Constant.bando;
import static com.seta.action.Constant.patterndatesql;
import static com.seta.action.Constant.secret;
import static com.seta.action.Constant.url;
...
import static com.seta.util.Utility.formatDate;
import static com.seta.util.Utility.generaId;
import static com.seta.util.Utility.redirect;
//import static com.seta.util.Utility.sendMailHtml;
                            ...
                            if (ActionB.verificaBando(bandorif)) {
                                ...
                                if (EmailValidator.getInstance().isValid(email)) {
                                    ...
                                    if (ins) {
                                        ...
                                        if (insert > 0) {
                                            //OTP
                                            boolean out = Engine.generaOTP(bandorif, numcell, username);
                                            if (out) {
                                                String dest[] = {email};
...
//                                                        boolean es = sendMailHtml(dest, "Registrazione", text, null);
                                                    try {
                                                        boolean es = SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati", dest, new String[]{}, text, "YES I START UP CALABRIA - Donne e Disoccupati - Registrazione");
                                                        if (es) {
...
//                }
        ...
        if (att) {
            if (!pres) {
                ...
                if (es) {
                    ...
                    try {
                        SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati", dest, new String[]{}, text, "YES I START UP CALABRIA - Donne e Disoccupati - Conferma invio domanda di partecipazione");
    ...
    protected void annulladomanda(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (es1) {
            ...
            try {
                ...
                boolean es = SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati", dest, new String[]{}, text, "YES I START UP CALABRIA - Donne e Disoccupati - Cancellazione Domanda di Partecipazione");
                if (!es) {
                    msg = "1";
                }
    ...
    protected void sendconvmail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati", to, cc, testo, "YES I START UP CALABRIA - Donne e Disoccupati - Invio convenzione del Soggetto Attuatore " + var[4], new File(ActionB.getPathConvenzioni(username, tipodoc)))) {
        ...
        if (!ActionB.verificaInvioConvenzione(username)) {
            if (ActionB.setStatoInvioDocumenti(username)) {
                try {
                    ...
                    testo = testo.replaceAll("@ragsoc@", var[4]);
                    SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati", to, new String[]{}, testo, "YES I START UP CALABRIA - Donne e Disoccupati - Caricamento documentazione da parte del Soggetto Attuatore " + var[4], null);
                } catch (Exception ex) {
                    Logger.getLogger(Operazioni.class.getName()).log(Level.SEVERE, null, ex);
                    ex.printStackTrace();
                }
    ...
    public void accettaDomanda(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (ActionB.setStatoDomandaAccRif(username, accRif, protocollo, "---")) {
            ...
            String to[] = {var[3]};
            try {
                SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati", to, new String[]{}, testo, "YES I START UP CALABRIA - Donne e Disoccupati - Accettazione domanda accreditamento");
            } catch (MailjetException ex) {
                Logger.getLogger(Operazioni.class.getName()).log(Level.SEVERE, null, ex);
            } catch (MailjetSocketTimeoutException ex) {
                Logger.getLogger(Operazioni.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void rigettaDomanda(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (ActionB.setStatoDomandaAccRif(username, accRif, "", motivazione)) {
            ...
            String to[] = {var[3]};
            try {
                SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati", to, new String[]{}, testo, "YES I START UP CALABRIA - Donne e Disoccupati - Rigetto presentazione domanda");
            } catch (MailjetException ex) {
                Logger.getLogger(Operazioni.class.getName()).log(Level.SEVERE, null, ex);
            } catch (MailjetSocketTimeoutException ex) {
                Logger.getLogger(Operazioni.class.getName()).log(Level.SEVERE, null, ex);
    ...
    protected void uploadMultiplo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String path = "/mnt/mcover/bandoba0i9/doc/";
