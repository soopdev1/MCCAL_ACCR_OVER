        ...
        if (msg.equals("0")) {
            if (ActionB.getConvenzioneROMA(username).trim().equals("")) {
                ...
                if (ActionB.insertConvenzioneROMA(username, nomefile.getPath())) {
                    ...
                    String to[] = {var[3]};
                    try {
                        SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati",to , new String[]{}, testo, "YES I START UP CALABRIA - Donne e Disoccupati - Caricamento convenzione controfirmata da Ente Nazionale Microcredito");
