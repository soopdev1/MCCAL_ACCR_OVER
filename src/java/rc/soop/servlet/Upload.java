                                ...
                                if (fileName.lastIndexOf(".") > 0) {
                                    ...
                                    if (estensione.equalsIgnoreCase(".pdf") || estensione.equalsIgnoreCase(".p7m")) {
                                        ...
                                        try {
                                            ...
                                            msg = "1";
                                            trackingAction(username, Utility.estraiEccezione(ex));
                                            nomefile = null;
                                        }
                                    } else {
                                        msg = "1";
        ...
        if (msg.equals("0")) {
            if (ActionB.getConvenzioneROMA(username).trim().equals("")) {
                ...
                if (ActionB.insertConvenzioneROMA(username, nomefile.getPath())) {
                    ...
                    String to[] = {var[3]};
                    SendMailJet.sendMail(Constant.titlepro, to, new String[]{}, testo, Constant.titlepro + " - Caricamento convenzione controfirmata da Ente Nazionale Microcredito");
